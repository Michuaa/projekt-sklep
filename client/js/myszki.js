...
const szósty = document.querySelector('#szósty')
    ...
    drugi.addEventListener('click', ()=>   {
        document.location.href = 'produkt.html?id=17'
    })
    trzeci.addEventListener('click', ()=>   {
        document.location.href = 'produkt.html?id=18'
    })
    czwarty.addEventListener('click', ()=>   {
        document.location.href = 'produkt.html?id=19'
    })
    piąty.addEventListener('click', ()=>   {
        document.location.href = 'produkt.html?id=20'
    })